...
//  Cells9
//
//  Created by Gregory Debicki on 12-05-25.
...
-(void)setup {
    ...
    col = C4GREY;
    numberOfCells = 200;
    libC4Sample = [C4Sample sampleNamed:@"libC4.wav"];
    [libC4Sample prepareToPlay];
...
-(void)firstPlayRecord {
    playLibC4 ++;
    [libC4Sample play];
}
//-(void)setup {
//    newAudioSample = [C4Sample sampleNamed:@"C4Loop.aif"];
//    [newAudioSample prepareToPlay];
//}
//
